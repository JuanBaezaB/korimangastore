            ...
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                ...
                <nav class="flex-shrink-0 my-2 my-sm-0 ms-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Gestion de Generos</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            ...
            <div class="block-options">
                <button class="btn btn-sm btn-alt-secondary btn-primary" data-bs-toggle="modal" data-bs-target="#add_genre" data-bs-whatever="@mdo">
            ...
            <table id="product-table" class="table table-bordered table-striped table-vcenter table-hover w-100 display">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="">
                            <form class=" delete" action="{{ route('delete_genre', $genre->id) }}" method="POST">
                                <div class=" btn-group">
                                    <button type="button" class="btn btn-sm btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#update_genre{{ $genre->id }}" data-bs-whatever="@mdo" title="Actualizar">
                            ...
                            <!-- Modal Actualizar-->
                            <div class="modal fade " id="update_genre{{ $genre->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('update_genre', $genre->id) }}" enctype="multipart/form-data" method="POST">
                                                @csrf
                                                {{ method_field('PATCH') }}
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="type" name="type" value="{{$genre->type}}" required>
                                                </div>
...
<div class="modal fade " id="add_genre" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('add_genre') }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label class="col-form-label">Nombre:</label>
