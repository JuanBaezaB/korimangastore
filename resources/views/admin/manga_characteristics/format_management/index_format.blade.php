...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Listado Formato</h1>
    ...
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            ...
            <div class="block-options">
                <button class="btn btn-sm btn-alt-secondary btn-primary" data-bs-toggle="modal" data-bs-target="#add_format" data-bs-whatever="@mdo">
            ...
            <table id="product-table" class="table table-bordered table-striped table-vcenter js-dataTable-full">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="">
                            <form class=" delete" action="{{ route('delete_format', $format->id) }}" method="POST">
                                <div class=" btn-group">
                                    <button type="button" class="btn btn-sm btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#update_format{{ $format->id }}" data-bs-whatever="@mdo" title="Actualizar">
                            ...
                            <!-- Modal Actualizar-->
                            <div class="modal fade " id="update_format{{ $format->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('update_format', $format->id) }}" enctype="multipart/form-data" method="POST">
                                                @csrf
                                                {{ method_field('PATCH') }}

                                                <div class="mb-3">
                                                    <label class="col-form-label">Nombre:</label>
                                                    <input type="text" class="form-control" name="name" value="{{$format->name}}" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="col-form-label">Descrición:</label>
                                                    <input type="text" class="form-control" id="descrition" name="description" value="{{$format->description}}" required>
                                                </div>
...
<div class="modal fade " id="add_format" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('add_format') }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label class="col-form-label">Nombre:</label>
