...
<div class="bg-image" style="background-image: url('/media/login/portada1.png');">
        <div class="content content-full">
            <div class="py-5 text-center">
                ...
                <h1 class="fw-bold my-2 text-white marca">Editar Perfil</h1>
                <h2 class="h4 fw-bold text-white marca">
                    {{ Auth::user()->name }}
                </h2>
                ...
                <div class="content content-full content-boxed">
                    <div class="block block-rounded">
                        <div class="block-content">
                            <form action="{{ route('cliente.editProfile', ['id' => auth()->user()->id]) }}"
                                ...
                                <div class="row push">
                                    <div class="col-lg-4">
                                        <p class="text-muted">
                                            La información vital de tu cuenta. Su nombre de usuario será visible
                                            públicamente.
                                        </p>
                                    </div>
                                    <div class="col-lg-8 col-xl-5">
                                        ...
                                        <div class="mb-4">
                                            <label class="form-label" for="dm-profile-edit-email">Dirección de
                            ...
                            <!-- Change Password -->
                            <form action="{{ route('cliente.editPassword', ['id' => auth()->user()->id]) }}"
                                method="POST" enctype="multipart/form-data">
                                @csrf
                                {{ method_field('PATCH') }}
                                ...
                                <div class="row push">
                                    <div class="col-lg-4">
                                        <p class="text-muted">
                                            Cambiar su contraseña de inicio de sesión es una manera fácil de mantener su
                                            cuenta segura.
                                        </p>
                                    </div>
                                    <div class="col-lg-8 col-xl-5">
                                        <div class="mb-4">
                                            <label class="form-label" for="dm-profile-edit-password">Contraseña
                                                actual</label>
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-12">
                                                <label class="form-label" for="dm-profile-edit-password-new">Nueva
                                                    contraseña</label>
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-12">
                                                <label class="form-label"
                                                    for="dm-profile-edit-password-new-confirm">Confirme su nueva
                                                    contraseña</label>
