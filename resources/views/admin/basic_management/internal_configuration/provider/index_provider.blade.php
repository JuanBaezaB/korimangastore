            ...
            <div class="block-header block-header-default">
                ...
                <div class="block-options">
                    <button class="btn btn-sm btn-alt-secondary btn-primary" data-bs-toggle="modal"
                        data-bs-target="#add_provider" data-bs-whatever="@mdo">
                        ...
                        @foreach ($providers as $provider)
                            <tr>
                                ...
                                <td class="">
                                    <form class=" delete" action="{{ route('delete_provider', $provider->id) }}"
                                        ...
                                        <div class=" btn-group">
                                            <button type="button" class="btn btn-sm btn btn-outline-primary"
                                                ...
                                                data-bs-target="#update_provider{{ $provider->id }}"
                                    ...
                                    <!-- Modal Actualizar-->
                                    <div class="modal fade " id="update_provider{{ $provider->id }}" tabindex="-1"
