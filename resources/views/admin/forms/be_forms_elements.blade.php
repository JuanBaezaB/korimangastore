                ...
                <form action="be_forms_elements.php" method="POST" enctype="multipart/form-data" onsubmit="return false;">
                        ...
                        <div class="col-lg-8 col-xl-5">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="password" class="form-control" id="example-password-input"
                                    name="example-password-input" placeholder="Password Input">
                            </div>
                            <div class="mb-4">
                    ...
                    <div class="row push">
                        ...
                        <div class="col-lg-8 col-xl-5">
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select" id="example-select-multiple" name="example-select-multiple"
                                    size="5" multiple>
                                    <option selected>Open this select menu</option>
                                    <option value="1">Option #1</option>
                                    <option value="2">Option #2</option>
                                ...
                                <div class="space-y-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="example-checkbox-default1" name="example-checkbox-default1" checked>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="example-checkbox-default3" name="example-checkbox-default3" disabled>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="space-x-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="example-checkbox-inline1" name="example-checkbox-inline1" checked>
                                        <label class="form-check-label" for="example-checkbox-inline1">Option 1</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="example-checkbox-inline2" name="example-checkbox-inline2">
                                        <label class="form-check-label" for="example-checkbox-inline2">Option 2</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="example-checkbox-inline3" name="example-checkbox-inline3" disabled>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="space-y-2">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="example-switch-default1" name="example-switch-default1" checked>
                                        <label class="form-check-label" for="example-switch-default1">Option 1</label>
                                    </div>
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="example-switch-default2" name="example-switch-default2">
                                        <label class="form-check-label" for="example-switch-default2">Option 2</label>
                                    </div>
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="example-switch-default3" name="example-switch-default3" disabled>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="space-x-2">
                                    <div class="form-check form-switch form-check-inline">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="example-switch-inline1" name="example-switch-inline1" checked>
                                        <label class="form-check-label" for="example-switch-inline1">Option 1</label>
                                    </div>
                                    <div class="form-check form-switch form-check-inline">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="example-switch-inline2" name="example-switch-inline2">
                                        <label class="form-check-label" for="example-switch-inline2">Option 2</label>
                                    </div>
                                    <div class="form-check form-switch form-check-inline">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="example-switch-inline3" name="example-switch-inline3" disabled>
                    ...
                    <div class="row push">
                        ...
                        <div class="col-lg-8 col-xl-5 overflow-hidden">
                            <div class="mb-4">
                                <label class="form-label" for="example-file-input" class="form-label">File
                                    Input</label>
                                <input class="form-control" type="file" id="example-file-input">
                            </div>
                            <div class="mb-4">
                                <label class="form-label" for="formFileMultiple" class="form-label">File Input
                                    (Multiple)</label>
                    ...
                    <div class="row push">
                        <div class="col-lg-4">
                            <p class="text-muted">
                                Block based checkboxes which enable you to put any content inside them, perfect for modern
                                selections
                            </p>
                        </div>
                        <div class="col-lg-8">
                            <div class="row items-push">
                                ...
                                <div class="col-md-6">
                                    <div class="form-check form-block">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="example-checkbox-block2" name="example-checkbox-block2" checked>
                    ...
                    <div class="row push">
                        <div class="col-lg-4">
                            <p class="text-muted">
                                You could also use block based radios, perfect for custom content selections such as modern
                                pricing tables
                            </p>
                        </div>
                        <div class="col-lg-8">
                                    ...
                                    <div class="form-check form-block">
                                        ...
                                        <label class="form-check-label" for="example-radio-block1">
                                            <span class="d-block fw-normal text-center my-3">
                                                ...
                                                <span
                                                    class="d-block fs-2 fw-light py-3 m-3 bg-body-light rounded">$5<small>
                                                        /m</small></span>
                                    ...
                                    <div class="form-check form-block">
                                        ...
                                        <label class="form-check-label" for="example-radio-block2">
                                            <span class="d-block fw-normal text-center my-3">
                                                ...
                                                <span
                                                    class="d-block fs-2 fw-light py-3 m-3 bg-body-light rounded">$15<small>
                                                        /m</small></span>
                                    ...
                                    <div class="form-check form-block">
                                        ...
                                        <label class="form-check-label" for="example-radio-block3">
                                            <span class="d-block fw-normal text-center my-3">
                                                ...
                                                <span
                                                    class="d-block fs-2 fw-light py-3 m-3 bg-body-light rounded">$30<small>
                                                        /m</small></span>
                        ...
                        <div class="col-lg-8 col-xl-5">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="password" class="form-control form-control-alt"
                                    id="example-password-input-alt" name="example-password-input-alt"
                                    placeholder="Password Input">
                            </div>
                            <div class="mb-4">
                                <label class="form-label" for="example-textarea-input-alt">Textarea</label>
                                <textarea class="form-control form-control-alt" id="example-textarea-input-alt" name="example-textarea-input-alt"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-xl-5">
                            ...
                            <div class="mb-4">
                                <input type="text" class="form-control form-control-alt is-valid"
                                    id="example-text-input-valid-alt" name="example-text-input-valid-alt"
                            ...
                            <div class="mb-4">
                                <input type="text" class="form-control form-control-alt is-invalid"
                                    id="example-text-input-invalid-alt" name="example-text-input-invalid-alt"
                                    placeholder="Alternative Style..">
                                <div class="invalid-feedback">Invalid feedback</div>
                            </div>
                            <div class="mb-4">
                                <label class="form-label" for="example-disabled-input">Disabled</label>
                                <input type="text" class="form-control" id="example-disabled-input"
                                    name="example-disabled-input" placeholder="Disabled State.." disabled>
                            </div>
                        </div>
                    </div>
                    <!-- END States -->
                        ...
                        <div class="col-lg-8 col-xl-5">
                            ...
                            <div class="mb-4">
                                <input type="text" class="form-control form-control-alt form-control-sm"
                                    id="example-text-input-sm-alt" name="example-text-input-sm-alt"
                                    placeholder="form-control-sm">
                            </div>
                            <div class="mb-4">
                                <label class="form-label" for="example-text-input-normal">Normal</label>
                                <input type="text" class="form-control" id="example-text-input-normal"
                                    name="example-text-input-normal" placeholder="..">
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                <input type="text" class="form-control form-control-alt form-control-lg"
                                    id="example-text-input-lg-alt" name="example-text-input-lg-alt"
