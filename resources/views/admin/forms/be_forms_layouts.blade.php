            ...
            <div class="block-content">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 space-y-2">
                        ...
                        <form class="row row-cols-lg-auto g-3 align-items-center" action="be_forms_layouts.php"
                            ...
                            <div class="col-12">
                                ...
                                <input type="password" class="form-control" id="example-if-password"
                                    name="example-if-password" placeholder="Password">
                            </div>
                            <div>
                        ...
                        <form class="row row-cols-lg-auto g-3 align-items-center" action="be_forms_layouts.php"
                            ...
                            <div class="col-12">
                                ...
                                <input type="email" class="form-control form-control-alt" id="example-if-email2"
                                    name="example-if-email2" placeholder="Email">
                            </div>
                            <div class="col-12">
                    ...
                    <div class="col-lg-8 col-xl-5">
                        ...
                        <form class="mb-5" action="be_forms_layouts.php" method="POST" onsubmit="return false;">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-8">
                                    <input type="password" class="form-control" id="example-hf-password"
                                        name="example-hf-password" placeholder="Your Password..">
                                </div>
                            </div>
                            <div class="row mb-4">
