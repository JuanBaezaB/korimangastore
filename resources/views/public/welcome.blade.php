                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://www.instagram.com/korimangastore/" class="underline text-gray-900 dark:text-white">Instagram</a></div>
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://www.facebook.com/Kori-Manga-Store-108678028046259" class="underline text-gray-900 dark:text-white">Facebook</a></div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    Visita nuestra Fan Page en Facebook, enterate de novedades, noticias, artículos y reacciona a nuestras publicaciones.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://www.google.com/maps/@-36.8264254,-73.0528476,20z" class="underline text-gray-900 dark:text-white">Tienda Física</a></div>
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://docs.google.com/spreadsheets/d/1kugVxHfw2fqV2WfjXpl8Ejt9hO0GGm02qgLUAi7TEuE/edit#gid=0" class="underline text-gray-900 dark:text-white">Revisa nuestro catálogo</a></div>
                            </div>
                            ...
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    ...
                                    <br>
                                    Pronto tendremos para tí nuestra Tienda Virtual, donde podrás revisar nuestro catálogo, con fotos, descripción, y promociones de nuestros productos, además de envíos a todo Chile.
                                </div>
                            </div>
                        </div>
                    </div>
