                    ...
                    <div class="card text-dark shadow mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text"><b>Series: </b>
                                @isset($product)
                                    @foreach ($product->series as $serie)
                                        <span style="background-color: #0DCAF0"
                                            class="badge badge-dark">{{ $serie->name }}</span>
                                    @endforeach
                                @endisset
                            </p>
                            <p class="card-text">
                            ...
                            <div class="text-center card-text">
                                <a href="/reservar" type="button" class="btn btn-warning border-dark ms-4 me-4 mb-3"><i
                                        class="pe-2 fa-solid fa-bookmark"></i>Reservar</a>
                                <a href="/comprar" type="button" class="btn btn-success border-dark ms-4 me-4 mb-3"><i
