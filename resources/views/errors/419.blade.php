        ...
        <div class="row">
            <div class="col-12 text-center">
                ...
                <div class="alert alert-danger d-flex align-items-center" role="alert">
                    <div>
                        <h3 class="mw-100"><b><i class="fa-solid fa-circle-info pe-2"></i>Error.</b> Su sesión ha expirado.</h3>
                    </div>
                  </div>
                <br>
                <h5>Puedes volver a iniciar sesión <a href="/login">aquí</a>.</h5>
                <br>
                <h5>O puedes regresar a nuestra página de <a href="/">inicio</a>.</h5>
                <br>
            </div>
